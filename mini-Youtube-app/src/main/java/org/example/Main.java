...
//            databaseInitializer.createVideoTagAssociationTable();
            databaseInitializer.dropVideoLikeTable();
            databaseInitializer.createVideoLikeTable();
            databaseInitializer.dropCollectionGroupTable();
            databaseInitializer.createCollectionGroupTable();
            databaseInitializer.dropVideoCollectionTable();
            databaseInitializer.createVideoCollectionTable();
            databaseInitializer.dropUserCoinTable();
            databaseInitializer.createUserCoinTable();
            databaseInitializer.dropVideoCoinTable();
            databaseInitializer.createVideoCoinTable();
            databaseInitializer.dropVideoCommentTable();
            databaseInitializer.createVideoCommentTable();
            databaseInitializer.dropLiveCommentTable();
            databaseInitializer.createLiveCommentTable();
            databaseInitializer.dropVideoViewTable();
            databaseInitializer.createVideoViewTable();
