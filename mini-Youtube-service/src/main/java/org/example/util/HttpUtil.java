...
//    }
    ...
    /**
     * HTTP GET request return outputStream
     * @param url request link
    ...
    public static OutputStream get(String url,
        ...
        con.connect();
        // put response from target url server in the response
...
//
//    /**
//     * HTTP POST request，请求参数使用map进行封装
//     * @param url request link
//     * @param params request params
//     */
...
//
//    /**
//     * HTTP POST request，请求参数使用json字符串
//     * @param url request link
//     */
...
//
//    /**
//     * HTTP POST request，请求参数使用json字符串, 可以配置请求头
//     * @param url request link
//     * @param params request params
//     */
...
//
//    /**
//     * HTTP POST request，请求参数形式为url-encoded
//     * @param url request link
//     * @param params request params
//     */
...
//
//    /**
//     * HTTP POST request，请求参数形式为form-data
//     * @param url request link
//     * @param params request params
//     */
...
//
//    /**
//     * HTTP POST request，请求参数形式为form-data， 可以设置请求头
//     * @param url request link
//     * @param params request params
//     */
//    public static HttpResponse postFormData(String url,
